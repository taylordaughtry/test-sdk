...
class ProductServicesApi extends \HappyCog\OsborneApi\Resources\Base\ApiClient
{
    ...
    /**
     * Operation productServicesProductServiceIdExclusiveGet
     *
     ...
     * @return \HappyCog\OsborneApi\ErpService\Model\ProductService[]
     */
    public function productServicesProductServiceIdExclusiveGet($productServiceId)
    {
        list($response) = $this->productServicesProductServiceIdExclusiveGetWithHttpInfo($productServiceId);
        return $response;
    }

    /**
     * Operation productServicesProductServiceIdExclusiveGetWithHttpInfo
     *
     * Get a list of Mutually Exclusive Product Services to a Product Service
     *
     * @param  int $productServiceId Product Service Id (required)
     ...
     * @return array of \HappyCog\OsborneApi\ErpService\Model\ProductService[], HTTP status code, HTTP response headers (array of strings)
     */
    public function productServicesProductServiceIdExclusiveGetWithHttpInfo($productServiceId)
    {
        $returnType = '\HappyCog\OsborneApi\ErpService\Model\ProductService[]';
        $request = $this->productServicesProductServiceIdExclusiveGetRequest($productServiceId);
    ...
    /**
     * Operation productServicesProductServiceIdExclusiveGetAsync
     *
     * Get a list of Mutually Exclusive Product Services to a Product Service
     *
     * @param  int $productServiceId Product Service Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productServicesProductServiceIdExclusiveGetAsync($productServiceId)
    {
        return $this->productServicesProductServiceIdExclusiveGetAsyncWithHttpInfo($productServiceId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productServicesProductServiceIdExclusiveGetAsyncWithHttpInfo
     *
     * Get a list of Mutually Exclusive Product Services to a Product Service
     *
     * @param  int $productServiceId Product Service Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productServicesProductServiceIdExclusiveGetAsyncWithHttpInfo($productServiceId)
    {
        $returnType = '\HappyCog\OsborneApi\ErpService\Model\ProductService[]';
        $request = $this->productServicesProductServiceIdExclusiveGetRequest($productServiceId);
    ...
    /**
     * Create request for operation 'productServicesProductServiceIdExclusiveGet'
     *
     * @param  int $productServiceId Product Service Id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productServicesProductServiceIdExclusiveGetRequest($productServiceId)
    {
        // verify the required parameter 'productServiceId' is set
        if ($productServiceId === null || (is_array($productServiceId) && count($productServiceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $productServiceId when calling productServicesProductServiceIdExclusiveGet'
            );
        }

        $resourcePath = '/product-services/{productServiceId}/exclusive';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
