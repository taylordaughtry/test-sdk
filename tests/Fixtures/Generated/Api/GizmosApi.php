...
class GizmosApi extends \HappyCog\OsborneApi\Resources\Base\ApiClient
{
    ...
    /**
     * Operation gizmosGizmoIdDeleteDelete
     *
     * Delete a Gizmo
     *
     ...
     * @return object
     */
    public function gizmosGizmoIdDeleteDelete($gizmoId)
    {
        list($response) = $this->gizmosGizmoIdDeleteDeleteWithHttpInfo($gizmoId);
        return $response;
    }

    /**
     * Operation gizmosGizmoIdDeleteDeleteWithHttpInfo
     *
     * Delete a Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     */
    public function gizmosGizmoIdDeleteDeleteWithHttpInfo($gizmoId)
    {
        $returnType = 'object';
        $request = $this->gizmosGizmoIdDeleteDeleteRequest($gizmoId);
    ...
    /**
     * Operation gizmosGizmoIdDeleteDeleteAsync
     *
     * Delete a Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gizmosGizmoIdDeleteDeleteAsync($gizmoId)
    {
        return $this->gizmosGizmoIdDeleteDeleteAsyncWithHttpInfo($gizmoId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation gizmosGizmoIdDeleteDeleteAsyncWithHttpInfo
     *
     * Delete a Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gizmosGizmoIdDeleteDeleteAsyncWithHttpInfo($gizmoId)
    {
        $returnType = 'object';
        $request = $this->gizmosGizmoIdDeleteDeleteRequest($gizmoId);
    ...
    /**
     * Create request for operation 'gizmosGizmoIdDeleteDelete'
     *
     * @param  int $gizmoId Gizmo Id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function gizmosGizmoIdDeleteDeleteRequest($gizmoId)
    {
        // verify the required parameter 'gizmoId' is set
        if ($gizmoId === null || (is_array($gizmoId) && count($gizmoId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $gizmoId when calling gizmosGizmoIdDeleteDelete'
            );
        }

        $resourcePath = '/gizmos/{gizmoId}/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * Get a list of Things for an Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
     *
     * @throws \HappyCog\OsborneApi\ErpService\ApiException on non-2xx response
     ...
     *
     * Create a new Thing for an Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
    ...
    /**
     * Operation gizmosGizmoIdThingsThingIdDeleteDelete
     *
     * Delete a Thing for an Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     * @return object
     */
    public function gizmosGizmoIdThingsThingIdDeleteDelete($gizmoId, $thingId)
    {
        list($response) = $this->gizmosGizmoIdThingsThingIdDeleteDeleteWithHttpInfo($gizmoId, $thingId);
        return $response;
    }

    /**
     * Operation gizmosGizmoIdThingsThingIdDeleteDeleteWithHttpInfo
     *
     * Delete a Thing for an Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function gizmosGizmoIdThingsThingIdDeleteDeleteWithHttpInfo($gizmoId, $thingId)
    {
        $returnType = 'object';
        $request = $this->gizmosGizmoIdThingsThingIdDeleteDeleteRequest($gizmoId, $thingId);
    ...
    /**
     * Operation gizmosGizmoIdThingsThingIdDeleteDeleteAsync
     *
     * Delete a Thing for an Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gizmosGizmoIdThingsThingIdDeleteDeleteAsync($gizmoId, $thingId)
    {
        return $this->gizmosGizmoIdThingsThingIdDeleteDeleteAsyncWithHttpInfo($gizmoId, $thingId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation gizmosGizmoIdThingsThingIdDeleteDeleteAsyncWithHttpInfo
     *
     * Delete a Thing for an Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gizmosGizmoIdThingsThingIdDeleteDeleteAsyncWithHttpInfo($gizmoId, $thingId)
    {
        $returnType = 'object';
        $request = $this->gizmosGizmoIdThingsThingIdDeleteDeleteRequest($gizmoId, $thingId);
    ...
    /**
     * Create request for operation 'gizmosGizmoIdThingsThingIdDeleteDelete'
     *
     * @param  int $gizmoId Gizmo Id (required)
     * @param  int $thingId Thing Id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function gizmosGizmoIdThingsThingIdDeleteDeleteRequest($gizmoId, $thingId)
    {
        // verify the required parameter 'gizmoId' is set
        if ($gizmoId === null || (is_array($gizmoId) && count($gizmoId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $gizmoId when calling gizmosGizmoIdThingsThingIdDeleteDelete'
            );
        }
        // verify the required parameter 'thingId' is set
        if ($thingId === null || (is_array($thingId) && count($thingId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $thingId when calling gizmosGizmoIdThingsThingIdDeleteDelete'
            );
        }

        $resourcePath = '/gizmos/{gizmoId}/things/{thingId}/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * Get info about a Thing for an Gizmo
     *
     * @param  int $gizmoId Gizmo Id (required)
     * @param  int $thingId Thing Id (required)
     *
     ...
     *
     * Get a list of Widgets for an Gizmo Thing
     *
     * @param  int $gizmoId Gizmo Id (required)
     * @param  int $thingId Thing Id (required)
     *
     ...
     *
     * Create a new Widget for an Gizmo Thing
     *
     * @param  int $gizmoId Gizmo Id (required)
     * @param  int $thingId Thing Id (required)
    ...
    /**
     * Operation gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDelete
     *
     * Delete an Widget for an Gizmo Thing
     *
     * @param  int $gizmoId Gizmo Id (required)
     * @param  int $thingId Thing Id (required)
     ...
     * @return object
     */
    public function gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDelete($gizmoId, $thingId, $widgetId)
    {
        list($response) = $this->gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteWithHttpInfo($gizmoId, $thingId, $widgetId);
        return $response;
    }

    /**
     * Operation gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteWithHttpInfo
     *
     * Delete an Widget for an Gizmo Thing
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteWithHttpInfo($gizmoId, $thingId, $widgetId)
    {
        $returnType = 'object';
        $request = $this->gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteRequest($gizmoId, $thingId, $widgetId);
    ...
    /**
     * Operation gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteAsync
     *
     * Delete an Widget for an Gizmo Thing
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteAsync($gizmoId, $thingId, $widgetId)
    {
        return $this->gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteAsyncWithHttpInfo($gizmoId, $thingId, $widgetId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteAsyncWithHttpInfo
     *
     * Delete an Widget for an Gizmo Thing
     *
     * @param  int $gizmoId Gizmo Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteAsyncWithHttpInfo($gizmoId, $thingId, $widgetId)
    {
        $returnType = 'object';
        $request = $this->gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteRequest($gizmoId, $thingId, $widgetId);
    ...
    /**
     * Create request for operation 'gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDelete'
     *
     * @param  int $gizmoId Gizmo Id (required)
     * @param  int $thingId Thing Id (required)
     * @param  int $widgetId Widget Id (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDeleteRequest($gizmoId, $thingId, $widgetId)
    {
        // verify the required parameter 'gizmoId' is set
        if ($gizmoId === null || (is_array($gizmoId) && count($gizmoId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $gizmoId when calling gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDelete'
            );
        }
        // verify the required parameter 'thingId' is set
        if ($thingId === null || (is_array($thingId) && count($thingId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $thingId when calling gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDelete'
            );
        }
        // verify the required parameter 'widgetId' is set
        if ($widgetId === null || (is_array($widgetId) && count($widgetId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $widgetId when calling gizmosGizmoIdThingsThingIdWidgetsWidgetIdDeleteDelete'
            );
        }

        $resourcePath = '/gizmos/{gizmoId}/things/{thingId}/widgets/{widgetId}/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * Get info about an Widget for an Gizmo Thing
     *
     * @param  int $gizmoId Gizmo Id (required)
     * @param  int $thingId Thing Id (required)
     * @param  int $widgetId Widget Id (required)
     ...
     *
     * Update an Widget for an Gizmo Thing
     *
     * @param  int $gizmoId Gizmo Id (required)
     * @param  int $thingId Thing Id (required)
     * @param  int $widgetId Widget Id (required)
